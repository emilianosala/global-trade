      ...
      <div className="gt-container gt-footer-grid" style={{ padding: "52px 24px 28px" }}>
        <div className="gt-footer-brand">
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 8, marginTop: 16, color: "var(--gt-gray-light)", fontSize: 14 }}>
            <span style={{ display: "inline-flex", alignItems: "center", gap: 8 }}><Icon.Phone size={16} /> +54 11 5555-0000</span>
            <span style={{ display: "inline-flex", alignItems: "center", gap: 8 }}><Icon.MapPin size={16} /> Buenos Aires, Argentina</span>
          </div>
        </div>
