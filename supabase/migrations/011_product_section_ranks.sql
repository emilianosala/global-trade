-- Orden curado por el admin de las secciones de la home (Destacados / Más
-- vendidos). Cada producto guarda una posición por sección (más chico = primero).
-- NULL = sin posición asignada (va al final, ordenado por nombre desde la app).
-- get_products expone las dos columnas nuevas; cambia el RETURNS TABLE, así que
-- se dropea y recrea con la misma firma de parámetros que 010.
